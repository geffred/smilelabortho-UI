    ...
    <div className='footer'>
       <footer className='container'>
        ...
        <div className='row'>
            ...
            {
                    sections.map((section)=><FooterComponentSection key={section.id} item={section}/>)
            }
        ...
        <div className='copyright'>
            <span> © {date.getFullYear()} Smile lab. Tous droits réservés.  </span>
            <div className='condition'> <a href="#">Conditions générales </a> </div>
        </div>
       </footer>
    </div>
    )
